        ...
        data.forEach(row => {
            ...
            html += `
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <td class="px-4 py-3 text-sm text-center font-semibold text-green-600 dark:text-green-400">${formatNumber(row.QTD_ENVIADO || 0)}</td>
                    <td class="px-4 py-3 text-sm text-center font-semibold text-blue-600 dark:text-blue-400">${formatNumber(row.QTD_PENDENTE_APROVACAO || 0)}</td>
                    <td class="px-4 py-3 text-sm text-center font-semibold text-yellow-600 dark:text-yellow-400">${formatNumber(row.QTD_AGENDADO_MKC || 0)}</td>
                    <td class="px-4 py-3 text-sm text-center font-semibold text-indigo-600 dark:text-indigo-400">${formatNumber(row.QTD_PENDENTE || 0)}</td>
                    <td class="px-4 py-3 text-sm text-center font-semibold text-red-600 dark:text-red-400">${formatNumber(row.QTD_NEGADO || 0)}</td>
                </tr>
            `;
        });
...
include $plugin_path . 'templates/base.php';